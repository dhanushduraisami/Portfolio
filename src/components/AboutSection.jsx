            ...
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        <h3 className="text-2xl font-semibold">Passinate web Developer & Tech Creator</h3>
                        <p className="text-muted-foreground">
                            I'm Passinate about creating elegent solution to complex 
                            problems,and I'm constantly learning new technologies and 
                            techniques to stay at the forefont of the ever-evolving 
                            web landscape.
                        </p>
                        <p className="text-muted-foreground">
                            I'm Passinate about creating elegent solution to complex 
                ...
                <div className="gradient-border p-6 cover-hover">
                ...
                <div className="gradient-border p-6 cover-hover">
                     <div className="flex items-start gap-4 ">
                        ...
                        <div className="text-left">
                         {" "}
                        <h4 className="font-semibold text-lg">Flutter</h4>
                        <p className="text-muted-foreground">
                            Creating responsive websites and web application with modern framework. 
                        </p>  
                        </div>
